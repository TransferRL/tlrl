...
from env.gym_maze.envs.maze_view_2d import MazeView2D
import numpy as np
...
class MazeEnv(gym.Env):
    ...
    def __init__(self, maze_file=None, maze_size=None, mode=None, display=False):
        self.name = 'Maze-v0'
        self.viewer = None
        ...
        if maze_file:
            self.maze_view = MazeView2D(maze_name="OpenAI Gym - Maze (%s)" % maze_file,
                                        ...
                                        screen_size=(640, 640), display=display)
        elif maze_size:
            if mode == "plus":
                has_loops = True
            ...
            self.maze_view = MazeView2D(maze_name="OpenAI Gym - Maze (%d x %d)" % maze_size,
                                        ...
                                        has_loops=has_loops, num_portals=num_portals, display=display)
        else:
        ...
        # observation is a matrix of obersvation size
        self.observation_space = spaces.MultiDiscrete(np.array([[0,1] for _ in range(self.action_space.n)]))
        ...
        # initial condition
        self.state = self.maze_view.current_view
